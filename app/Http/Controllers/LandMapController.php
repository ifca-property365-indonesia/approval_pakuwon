    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $dataArray = [
                ...
                'land_area_spk'     => number_format($request->land_area_spk, 2, '.', ','),
                'land_area_bpn'     => number_format($request->land_area_bpn, 2, '.', ','),
                'map_land_no'       => $request->map_land_no,
                'land_title_no'     => $request->land_title_no,
                'land_area_final'   => number_format($request->land_area_final, 2, '.', ','),
